...
namespace Keap.Sdk
{
    ...
    {
        /// <summary>
        /// Use this for debugging purposes. If you want to print out a bunch of messages so you can
        /// log the exact flow of your program, use this. If you want to keep a log of variable
        /// values, use this.
        /// </summary>
        ...
        /// <summary>
        /// This event is automatically wired up when you use any of the Authentication Methods
        /// </summary>
        public static event PersistAccessTokenCredentialsHandler OnPersistAccessTokenCredentials;
        ...
        public static void ClearAllListeners()
        {
            ...
            ClearPersistAccessTokenCredentialsListeners();
        }

        internal static void ClearLogListeners()
        {
            try
            {
        ...
        internal static void ClearPersistAccessTokenCredentialsListeners()
        {
            try
            {
                if (OnPersistAccessTokenCredentials != null)
                {
                    foreach (Delegate invoker in OnPersistAccessTokenCredentials.GetInvocationList())
                    {
                        OnPersistAccessTokenCredentials -= (PersistAccessTokenCredentialsHandler)invoker;
                    }
                }
            }
            catch (Exception e)
        ...
        /// <returns><c>true</c> if the specified log level is listening; otherwise, <c>false</c>.</returns>
        ...
        internal static void PersistAccessTokenCredentials(Domain.AccessTokenCredentials e)
        {
            OnPersistAccessTokenCredentials?.Invoke(e);
        }

        /// <summary>
        /// Inspects the log level of the event data and triggers the corresponding event if there
        /// is a listener.
        /// </summary>
